      ...
      >
        ...
        <div className="p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
          <div className="text-white/80 space-y-4">
            <p className="text-xs sm:text-sm text-white/60">Version v0.1.3</p>
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <a
                ...
                className="flex items-center gap-2 text-xs sm:text-sm text-white/60 hover:text-white/90 transition-colors duration-300"
              >
